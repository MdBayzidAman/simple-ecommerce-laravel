    ...
    <div class="wrapper">
      <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
          <a class="sidebar-brand" href="/management">
          ...
          <ul class="sidebar-nav">
            ...
            <li class="sidebar-item @yield('dashboard_nav')">
            ...
            <!-- product -->
            <li class="sidebar-item @yield('product_nav')">
              <a class="sidebar-link collapsed" data-bs-target="#products" data-bs-toggle="collapse" aria-expanded="false">
                <i class="align-middle" data-feather="shopping-bag"></i>
                <span class="align-middle">products</span>
              </a>
              <ul id="products" class="sidebar-dropdown list-unstyled collapse @yield('product_nav_show')" data-bs-parent="#sidebar">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link" href="{{route('add.product')}}">
                    <i class="align-middle" data-feather="arrow-right"></i>
                    <span class="align-middle">Add products</span>
                  </a>
                </li>
              </ul>
            </li>
            <!-- category -->
            <li class="sidebar-item @yield('category_nav')">
              <a class="sidebar-link collapsed" data-bs-target="#category" data-bs-toggle="collapse" aria-expanded="false">
                <i class="align-middle" data-feather="grid"></i>
                <span class="align-middle">Category</span>
              </a>
              <ul id="category" class="sidebar-dropdown list-unstyled collapse @yield('category_nav_show')" data-bs-parent="#sidebar">
                <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link" href="{{route('add.category')}}">
                    <i class="align-middle" data-feather="arrow-right"></i>
                    <span class="align-middle">Add Categories</span>
                  </a>
                </li>
              </ul>
            </li>
      ...
      <div class="main">
          ...
          <div class="navbar-collapse collapse">
            <ul class="navbar-nav navbar-align">
                  ...
                  <div class="list-group">
                    <a href="#" class="list-group-item">
                      <div class="row g-0 align-items-center">
                        <div class="col-2">
                          <img
                            src="{{ asset('asset/admin/img/avatars/avatar-5.jpg') }}"
                    ...
                    <a href="#" class="list-group-item">
                      <div class="row g-0 align-items-center">
                        <div class="col-2">
                          <img
                            src="{{ asset('asset/admin/img/avatars/avatar-2.jpg') }}"
                            class="avatar img-fluid rounded-circle"
                            alt="William Harris"
                          />
                        </div>
                    ...
                    <a href="#" class="list-group-item">
                      <div class="row g-0 align-items-center">
                        <div class="col-2">
                          <img
                            src="{{ asset('asset/admin/img/avatars/avatar-4.jpg') }}"
                            class="avatar img-fluid rounded-circle"
                            alt="Christina Mason"
                          />
                        </div>
                    ...
                    <a href="#" class="list-group-item">
                      <div class="row g-0 align-items-center">
                        <div class="col-2">
                          <img
                            src="{{ asset('asset/admin/img/avatars/avatar-3.jpg') }}"
                            class="avatar img-fluid rounded-circle"
                            alt="Sharon Lessman"
                          />
                        </div>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img
                    src="{{ asset('asset/admin/img/avatars/avatar.jpg') }}"
        ...
        <main class="content">
          ...
          @include('layout.massages')
          @yield('adminPanelMain')
